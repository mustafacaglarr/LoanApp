            ...
            Column(
                ...
                Row(
                    ...
                    Button(
                        ...
                        modifier = Modifier.weight(1f).absolutePadding(right = 2.dp).shadow(elevation = 10.dp)
                    ) {
                        Text(
                            text = "Borç",
                    ...
                    Button(
                        ...
                        modifier = Modifier.weight(1f).shadow(elevation = 10.dp)
                    ) {
                        Text(
                            text = "Alacak",
                            style = TextStyle(color = Color.Black)
                ...
                Button(
                    onClick = {
                        if(isDebtSelected==true){
                            creditAmount = "0.0"
                            //debtsViewModel.saveDebt(name, phoneNumber, debtAmount.toDouble(), description)
                            ...
                            debtAmount = "0.0"
                            debtsViewModel.saveCreditandDebt(name, phoneNumber, debtAmount.toDouble(), creditAmount.toDouble(), description)
                            //debtsViewModel.saveCredit(name, phoneNumber, creditAmount.toDouble(), description)
                            navController.navigate("home")
                        }
